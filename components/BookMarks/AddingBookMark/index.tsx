...
const AddingBookMark: FC = () => {
  return (
    <div className="cursor-pointer bg-gray-100 rounded-lg flex items-center justify-center px-3 h-20 md:bg-transparent md:w-28 md:h-28 md:flex-col md:hover:bg-white/10 md:p-0">
